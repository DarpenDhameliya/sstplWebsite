...
const Portfoliyo = () => {
  ...
  const handle_modal = (e, data) => {
    ...
    setBtnclick(1);
    setTechnoLen(updatedState.technology.length -1)
    setSendMsg(updatedState);
  };
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6" key={index}>
                              <div className="softstormweb-ourwork-main-teb mt-30 ">
                                <div className="thumb" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onClick={() => handle_modal(e)}>
                                  <img src={e.image} alt="" />
                                  {/* <ul>
                                    <li className="hoverLi_ourwork">
                                      <a href="#">
                                        about
                                        <i className="fa fa-arrow-right-long ml-2"></i>
                                      </a>
                                    </li>
                                  </ul> */}
                                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="d-flex  align-items-center">
                          ...
                          <div className="ml-3" style={{widget: "100%"}}>
                            ...
                            <div className="d-flex">
                              {/* <p className="handelmobileh6">React</p> <span className="comaseperate_portfoliyo">, </span>
                              <p className="handelmobileh6">React</p> */}
                            {sendMsg.technology.map((ea, index) => {
                                if(technoLen === index){
                                  return (<><p className="handelmobileh6">{ea}</p></>)
                                } else {

                                return (<><p className="handelmobileh6">{ea}</p><span className="comaseperate_portfoliyo">, </span></>)
                                }
                            })}
                            </div>
                          </div>
                      ...
                      {/* <div className="col-6  mt-3">
                        <div className="text-center">
                          <img src={mob3} alt="imagheader" className="handle_portfolio_modal_icons" />
