...
export default function Testimonial(className) {
    ...
    let data = [
      {
        image: battel,
        title:
          "Team has a Expert of technical knowledge and SoftStorm can work any thing which is hard in technology, I have experienced solving any difficult problem with very carefully.",
        owner: "Rakesh Patil",
      ...
      },
      {
        image: sk,
        title:
          "Softstrom has Convert our complex business process to very easy and calculative. if we talk about the support of the team then i am giving 100% performance. Thank you softstorm.",
      ...
      },
      {
        image: macswin,
        title:
          "The SSTPL team has a unique strength that easily understands our Ideas and implements it with Application.",
        owner: "Kartik Donda",
      ...
      },
      {
        image: mectech,
        title:
          "Looking at the knowledge that both partner of Softstorm, I would say that they are the new Tony Stark of the world of technology.",
        owner: "Anil Tarpara",
      ...
      },
      {
        image: redient,
        title:
          "Looking at the technical knowledge and innovative ideas of Softstorm, everyone can say that the company will make great strides in the future.",
  ...
  return (
    <>
      <section
        className={`softstormweb-testimoial pt-70 pb-80 ${className || ""}`}
      >
        <div className="container">
          <div className="row">
            <div className="col-lg-7 col-md-6">
              <div className="softstormweb-left-testimoial">
                <div className="handletestimnoal_teb">
                  <h3 className="title mobiletitle_testimonial ">
                    Testimonial
                  </h3>
                  ...
                  <p>
                  We believe in the rewards of hard work. Our exceptional services are validated by positive ratings and reviews on various platforms. Explore customer testimonials to make an informed decision based on their experiences, feedback, and success stories.
                  </p>
            ...
            <div className="col-lg-5 col-md-6">
              <div
                className="softstormweb-right-testimoial handleview"
                      ...
                      <div className="item doublequate" key={index}>
                        <p className="pb-3 pl-10">
                          <sup>
                            {" "}
                            <i
                              className="fa fa-quote-left fafaquatsstart"
                              aria-hidden="true"
                            ></i>
                          </sup>
                          {e.title}
                          ...
                          <i
                            className="fa fa-quote-right fafaquatsend"
                            aria-hidden="true"
                          ></i>
                        </p>
