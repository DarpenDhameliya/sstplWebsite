    ...
    <>
      <List className={classes.selectedindex}>
        ...
        <Tooltip title={"Privacy"} placement="right">
          <ListItemButton button component={Link} to="/online-admin/dashboard/privacy" selected={"/online-admin/dashboard/privacy" === location.pathname} className={classes.effectlist}>
            <ListItemIcon style={{minWidth: "45px"}}>
              <i className={`fa fa-circle-user  ${classes.SidebarImg}`}></i>
            </ListItemIcon>
