          ...
          <div className="row">
            <div className="col-lg-8 col-md-7 ">
              <div className="single-post-area">
                ...
                <span id="php" style={{paddingTop: "15px"}}></span>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className={`softstormweb-web-service`} style={{marginTop: "20px"}} ref={ref1}>
                      <div className="content">
                        ...
                        <ul className="ml-15 mt-2 handlelist">
                          <li>
                            {/* <img src={singlePost} alt='symbol'  className="handlecarrericon "/> */}
