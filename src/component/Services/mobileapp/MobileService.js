            ...
            <div className="row align-items-center">
              <div className="col-lg-12">
                <div className=" d-flex">
                  <div>
                    <a
                      className={` handleservice_header pl-3 pr-3 ${
                        tab === "ios" ? "subHadactive" : ""
                      }`}
                      style={{ color: "#fff", paddingTop: "12px" }}
                      href="#ios"
                    >
                      IOS
                    </a>
                  </div>{" "}
                  <span style={{ margin: "12px 5px 0 ", color: "white" }}>
                    |
                  </span>
                  <div>
                    <a
                      className={`handleservice_header pl-3 pr-3 ${
                        tab === "flutter" ? "subHadactive" : ""
                      }`}
                      style={{ color: "#fff", paddingTop: "12px" }}
                      href="#flutter"
                    >
          ...
          <div className="row">
            <div className="col-lg-8 col-md-7 ">
              <div className="single-post-area">
                ...
                <span id="ios" style={{ paddingTop: "15px" }}></span>
                <h4 className="article-title mt-1">Mobile Applocation</h4>
                <header
                  className="service-header_small haderhide"
                  id="service-header_id"
                >
                  <div className="container">
                    <div className="header-nav-box">
                      <div className="row align-items-center">
                        <div className="col-lg-12">
                          <div className=" d-flex">
                            <div>
                              <a
                                className={` handleservice_header  pl-2 pr-2 ${
                                  tab === "ios" ? "subHadactive" : ""
                                }`}
                                style={{ color: "#fff", paddingTop: "12px" }}
                                href="#ios"
                  ...
                  <div className="col-lg-12">
                    ...
                    >
                      <div className="content">
                        ...
                        <p>
                          If your business demands a website which needs to
                          gather information. Then PHP is the tool of choice.
                          PHP gives web developers the ability to create dynamic
                          web pages, which can collect data from visitors.
                          Perfect for those business concerns which rely on
                          capturing data. Travel Agents, Hospitals and similar
                          concerns should go for PHP.
                        </p>
                  ...
                  <div className="col-lg-12">
                    ...
                    >
                      <div className="content">
                        ...
                        <p>
                          Perhaps the most popular PHP development framework of
                          present times. Perfect for travel aggregators and
                          similar business. It is light and flexible. Data and
                          logic based services are constructed on this
                          framework.
                        </p>
                        <h6>SoftStorm Provides:</h6>
                        <ul className="ml-15 mt-2 handlelist">
                  ...
                  <div className="col-lg-12">
                    ...
                    >
                      <div className="content">
                        ...
                        <p>
                          A perfect tool for SME industry and their web
                          development needs. This framework gives the freedom of
                          deploying highly multifunctional websites quickly.
                          Department level, functional web development, and data
                          integration are possible with Laravel.
                        </p>
                        <h6>SoftStorm Provides:</h6>
                        <ul className="ml-15 mt-2 handlelist">
