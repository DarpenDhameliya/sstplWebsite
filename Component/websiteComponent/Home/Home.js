...
import shape15 from "../../../assets/images/PERSANTAGE (3).webp";
import shapeThree from "../../../assets/images/curly brecket (1).webp";
import Link from "next/link";
import Image from "next/image";
import Lottie from "lottie-react";
import homedata from "./fM1Ya2VfEr.json";
import style from "./cssComponent/Home.module.css";

const Home = () => {
  return (
    <>
      <section className={style.websitecssarea}>
        <div className="container">
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6 col-md-11">
              <div className="website-css-content">
                <h4 className="pb-3 fw-600">Digitalize Businesses Across the World</h4>
                <h2 className={`pb-3 ${style.handle_home_animat}`}>Trusted Service </h2>
                <div className={`d-flex text-center ${style.softstorm_home_tebview} pb-3`}>
                  <h2 className={style.handle_home_animat}>Provider for</h2>
                ...
                <p className={`${style.home_effect_p} pb-2`}>Save time to build your business, let us build the softwares and apps for you!</p>
            ...
            <div className="col-lg-6 col-md-11">
              <div className={style.website_css_thumb} activeClassName="active-link" data-aos-duration="2000" data-aos="fade-up">
