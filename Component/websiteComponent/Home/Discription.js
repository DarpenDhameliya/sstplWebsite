...
// import CounterUpCom from "../SubComponent/lib/CounterUpCom";
        ...
        <div className="container">
          ...
          <div className="row mt-20" data-aos-duration="1000" data-aos="fade-up">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="softstormweb-counter-discription" data-wow-duration="2000ms" data-wow-delay="200ms">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="softstormweb-counter-discription  item-2 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="400ms">
                <div className="counter-content">
                  <div className="icon">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="softstormweb-counter-discription  item-3 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="600ms">
                <div className="counter-content">
                  <div className="icon">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="softstormweb-counter-discription  item-4 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="800ms">
                <div className="counter-content">
                  <div className="icon">
