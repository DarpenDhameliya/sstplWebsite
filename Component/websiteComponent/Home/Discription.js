...
import style from './cssComponent/Discription.module.css'
const CounterUpCom = dynamic(() => import("../SubComponent/lib/CounterUpCom"), { ssr: false, loading: () => <Loader /> });
export default function Discription() {
  return (
    <>
      <div className={` ${style.softstormweb_discription} pt-70 pb-120`} id="counter">
        <div className="container">
          <div className={style.softstormweb_title}>
            <p className={` ${style.softstormweb_title_discription} d-flex justify-content-center`}>We Are SoftStorm.</p>
          ...
          <div className="row mt-20" data-aos-duration="1000" data-aos="fade-up">
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className={style.softstormweb_counter_discription} data-wow-duration="2000ms" data-wow-delay="200ms">
                <div className={style.counter_content}>
                  <div className="icon">
                    <Image src={counterIconOne} alt="Global clients" />
                  </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className={` ${style.softstormweb_counter_discription}  ${style.item_2} wow animated fadeInUp`} data-wow-duration="2000ms" data-wow-delay="400ms">
                <div className={style.counter_content}>
                  <div className="icon">
                    <Image src={counterIconTwo} alt="Success Project" />
                  </div>
                  <h3 className={style.title}>
                    <span className="counter-item">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className={` ${style.softstormweb_counter_discription}  ${style.item_3} wow animated fadeInUp`} data-wow-duration="2000ms" data-wow-delay="600ms">
                <div className={style.counter_content}>
                  <div className="icon">
                    <Image src={counterIconThree} alt="Client Satisfaction" />
                  </div>
                  <h3 className={style.title}>
                    <span className="counter-item">
            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className={` ${style.softstormweb_counter_discription}  ${style.item_4} wow animated fadeInUp`} data-wow-duration="2000ms" data-wow-delay="800ms">
                <div className={style.counter_content}>
                  <div className="icon">
                    <Image src={counterIconFour} alt="Tech Experts Team" />
                  </div>
                  <h3 className={style.title}>
                    <span className="counter-item">
