...
const CommonLowerFooter = () => {
  ...
  return (
    <>
      <section className=" softstormweb-footer-area-about-1">
          ...
          <div className="row">
            <div className="col-lg-12">
              ...
              <div className="col-lg-12  mt-2">
                ...
                >
                  <div className={`col-md-6 col-sm-6 align-items-center pr-0 ${style.handlemobilfooter} ${style.handleview_footer}`}>
                    <FooterLink className={`${style.footer_bottomLinks} mr-2 ml-2`} href="/about-us">
                      About Us
                    </FooterLink>
                    <span> | </span>
                    <FooterLink className={`${style.footer_bottomLinks} mr-2 ml-2`} href="/our-work">
                      Our Work
                    </FooterLink>
                    <span> | </span>
                  </div>
                  <div className={`col-md-6 col-sm-6 align-items-center pl-0 ${style.handlemobilfooter}`}>
                    <FooterLink className={`${style.footer_bottomLinks} mr-2 ml-2`} href="/career">
                      Career
                    </FooterLink>
                    <span> | </span>
                    <FooterLink className={`${style.footer_bottomLinks} mr-2 ml-2`} href="/contact-us">
                      Contact us
                    </FooterLink>
                  </div>
                </div>
