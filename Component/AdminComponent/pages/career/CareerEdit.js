      ...
      <Container component="main" maxWidth="xl" className={styles.setcontainer}>
        ...
        <div className={`sstpl-visible ${loading === false ? "active" : ""}`}>
          <div className="setpageheading_withback">
            <Link scroll={false} href='/online-admin/dashboard/careerdetails' className={styles.handlebackbutton} >
            <i className="fa fa-arrow-left black fs-25" aria-hidden="true"></i>
            </Link>
            <Typography variant="h4" gutterBottom className={` ${styles.setheading} ml-4`}>
              Edit Career Details
            </Typography>
          </div>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={4} className="setinputlayout">
              <Paper className={styles.setProductpaper} elevation={5}>
                ...
                <Typography className={styles.setlabel}>Loction :</Typography>
                ...
                <Typography className={styles.setlabel}>Experience :</Typography>
                ...
                <Typography className={styles.setlabel}>Qualification :</Typography>
                ...
                <Typography className={styles.setlabel}>Position in Front :</Typography>
            ...
            <Grid item xs={12} sm={8} className="setinputlayout">
              <Paper className={styles.setProductpaper} elevation={5}>
                <Typography className={styles.setlabel}>Responsibilitys :</Typography>
